...
class HometypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hometype.index')->with('info', 'Добавлено успешно!');
    }
    ...
    public function update(Request $request, Hometype $hometype)
    {
        ...
        return redirect()->route('hometype.index')->with('info', 'Редактировано успешно!!!');
    }
    ...
    {
        $hometype->delete();
        return redirect()->route('hometype.index')->with('info', 'Удалено успешно!!!');
    }
}
