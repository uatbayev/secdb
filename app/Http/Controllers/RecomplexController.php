...
class RecomplexController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('recomplex.index')->with('info', 'Добавлено успешно!');
    }
    ...
    public function update(Request $request, Recomplex $recomplex)
    {
        ...
        return redirect()->route('recomplex.index')->with('info', 'Редактировано успешно!!!');
    }
    ...
    {
        $recomplex->delete();
        return redirect()->route('recomplex.index')->with('info', 'Удалено успешно!!!');
    }
}
