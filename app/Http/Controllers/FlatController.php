...
class FlatController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('flat.index')->with('info', 'Добавлено успешно!');
    }
    ...
    public function update(Request $request, Flat $flat)
    {
        ...
        return redirect()->route('flat.index')->with('info', 'Редактировано успешно!!!');
    }
    ...
    {
        $flat->delete();
        return redirect()->route('flat.index')->with('info', 'Удалено успешно!!!');
    }
