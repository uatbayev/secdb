...
return [
    ...
    'attributes'           => [
        ...
        'gender_id'               => 'Пол',
        'tel'               => 'Телефон',
        'main_region_id' => 'Область, откуда прибыл',
        ...
        'identity_document_id'               => 'Документ, удостоверяющий личность',
        'doc_number'               => 'Номер документа, удостоверяющего личность',
        'doc_give_date'               => 'Дата выдачи документа, удостоверяющего личность',
        'doc_end_date'               => 'Срок действия документа, удостоверяющего личность',
        'ud_scan'               => 'Скан копию документа, удостоверяющего личность',
        'at_scan'               => 'Аттестат с приложением, диплом об оканчании колледжа с приложением',
        'grant_scan'               => 'свидетельства о гранте',
        'admission_date'               => 'Дата поступления',
        'education_admission_id'               => 'Образование при поступлении',
        'education_doc_name'               => 'Номер документа',
        'education_give_date'               => 'Дата выдачи',
        'grant_give_date'               =>  'Дата присуждения гранта',
        ...
        'parent_phone'               => 'Мобильный телефон (родителей)',
        'cafedra_id'                   => 'Кафедра',
        'faculty_id'                   => 'Факультет',
        'specializationCode'                   => 'Код',
        'code'                   => 'Код',
        'codekk'                   => 'Код на казахском',
        'coderu'                   => 'Код на русском',
        'codeen'                   => 'Код на английском',
        'professionCode'                   => 'Код',
        'professiontype_id'                   => 'Направление',
        ...
        'department_type_id'                   => 'Виды департаментов',
        'department_id'                   => 'Департаменты',
        'employee_part_id'                   => 'Отделение',
        'employee_part'                   => 'Отделение',
        'is_head'                   => 'Руководитель',
        'academicyear_id'                   => 'Учебный год',
        'education_type_id'                   => 'Образование',
        'institut_name'                   => 'Наименование образовательного учреждения',
        'finish_year'                   => 'Год окончания',
        'position_type_id'                   => 'Типы должностей',
        'position_time_type_id'                   => 'Штат',
        'time_rate'                   => 'Ставка',
        'employee_order_type_id'                   => 'Виды приказов',
        'order_number'                   => 'Номер приказа',
        'order_date'                   => 'Дата приказа',
        'position_id'                   => 'Позиция',
        'employee_document_type_id'                   => 'Вид документов',
        ...
        'order_type_category'   => 'Категория',
        'order_name'            => 'Название приказа',
        'student_id'            => 'Студент',
        'users' => [
            'input' => [
                '*' => [
    ...
    'header' => [
        'error'         => 'Приведенные данные были недействительными',
        'success_save'    => 'Данные успешно сохранены',
        'success_delete'  => 'Данные успешно удалены',
        'success'         => 'Данные успешно обработаны',
    ],
];
