...
<main class="flex-shrink-0">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container px-5">
            <a class="navbar-brand" href="{{ route('home') }}">Жилые комплексы г.Нур-Султан</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="{{ route('home') }}">Главная</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('page') }}">Жилые комплексы</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('home_faq') }}">Вопросы-ответы</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownPortfolio">
                            ...
                            <li><a class="dropdown-item" href="{{ route('auth.register') }}">Регистрация</a></li>
...
<footer class="bg-dark py-4 mt-auto">
    <div class="container px-5">
        <div class="row align-items-center justify-content-between flex-column flex-sm-row">
            <div class="col-auto"><div class="small m-0 text-white">Все права защищены &copy; Жилые комплексы г.Нур-Султан 2022</div></div>
            <div class="col-auto">
                <a class="link-light small" href="{{ route('page') }}">Жилые комплексы</a>
                <span class="text-white mx-1">&middot;</span>
                <a class="link-light small" href="{{ route('home_faq') }}">Вопросы-ответы</a>
            </div>
        </div>
    </div>
</footer>
